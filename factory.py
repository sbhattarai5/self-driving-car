...
def factory():
    ...
    carmodel = VehicleModel(car_image, car_x, car_y, car_dx, car_dy, car_ddx, car_ddy, car_target_dx,
                            car_target_dy, car_max_dy, car_angle, 'Black_viper')
    carcontrol = VehicleControlUser(carmodel)
    carview = VehicleView(carmodel)
    audimodel = VehicleModel(audi_image, audi_x, audi_y, audi_dx, audi_dy, audi_ddx, audi_ddy,
                             audi_target_dx, audi_target_dy, audi_max_dy, audi_angle, 'Audi')
