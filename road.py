...
class RoadModel:
    def __init__(
        ...
        self.road = (
            self.road_x,
            self.road_y,
            self.num_lanes * self.lane_width,
            self.road_height,
        )
...
class RoadControl:
    ...
    def setDividers(self):
        ...
        start_y = int(self.road_model.carmodel.y)
        remainder = start_y % (
    ...
    def runRoad(self):
        self.road_model.road_y = self.road_model.carmodel.y - 17.6
        self.road_model.road = (
            self.road_model.road_x,
            self.road_model.road_y,
            self.road_model.num_lanes * self.road_model.lane_width,
            self.road_model.road_height,
        )
...
class RoadView:
    ...
    def run(self):
        ...
        vrect = viewwindow.transform_rect(
            self.road_model.road[0],
            self.road_model.road[1],
